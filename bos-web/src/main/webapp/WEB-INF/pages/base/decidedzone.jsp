...
<script type="text/javascript">
	...
	function doAssociations(){
		...
		if(rows.length != 1){
			...
			var url = "${pageContext.request.contextPath }/decidedzoneAction_findListNotAssociation.action";
	...
	function doDblClickRow(index, row){
		...
		$('#association_subarea').datagrid( {
			...
			striped : true,
			pagination : true,
			url : "${pageContext.request.contextPath }/subareaAction_findBydDecidedzoneId.action?decidedzoneId="+row.id,
			//findBydDecidedzoneId
			columns : [ [{
				field : 'id',
				title : '分拣编号',
				width : 120,
		...
		$('#association_customer').datagrid( {
			...
			striped : true,
			pagination : true,
			url : "${pageContext.request.contextPath }/decidedzoneAction_findListHasAssociation?id="+row.id,
			columns : [[{
				field : 'id',
				title : '客户编号',
				width : 120,
					...
					<tr>
						...
						<td>
							<input class="easyui-combobox" name="staff.id"  
    							...
    							url:'${pageContext.request.contextPath }/staffAction_findAll.action'" />  
						</td>
					</tr>
					<tr height="300">
